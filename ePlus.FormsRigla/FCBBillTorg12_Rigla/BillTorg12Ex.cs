...
namespace BillTorg12_Rigla
{
  public class BillTorg12_Rigla : AbstractDocumentReport, IExternalDocumentPrintForm
	{
		...
		{
      Stream s = this.GetType().Assembly.GetManifestResourceStream("BillTorg12_Rigla.BillTorg12.sql");
		...
		public override IReportForm GetReportForm(DataRowItem dataRowItem)
		{
			...
			using (SqlDataAdapter sqlda = new SqlDataAdapter("REPEX_BILL_TORG12_RIGLA", connectionString))
			{
