...
IF (OBJECT_ID('DBO.REPEX_ACT_RETURN_TO_CONTRACTOR_INVOICE_RIGLA') IS NULL) EXEC ('CREATE PROCEDURE DBO.REPEX_ACT_RETURN_TO_CONTRACTOR_INVOICE_RIGLA AS RETURN')
GO
ALTER PROCEDURE DBO.REPEX_ACT_RETURN_TO_CONTRACTOR_INVOICE_RIGLA
	@XMLPARAM NTEXT AS
...
SELECT
    ...
    [COUNTRY] = C.NAME,
	GTD_NUMBER = L.GTD_NUMBER--CASE WHEN CT.NAME <> 'россия' THEN L.GTD_NUMBER ELSE '' END--chsa
	--select *
...
--EXEC DBO.REPEX_ACT_RETURN_TO_CONTRACTOR_INVOICE_RIGLA N'<XML><ID_GLOBAL>AB6B8EA3-D2F4-41E8-A4FC-71061C314EF1</ID_GLOBAL></XML>'