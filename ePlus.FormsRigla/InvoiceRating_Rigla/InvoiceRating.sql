...
IF OBJECT_ID('DBO.REPEX_INVOICE_RATING_RIGLA') IS NULL EXEC('CREATE PROCEDURE DBO.REPEX_INVOICE_RATING_RIGLA AS RETURN')
GO
ALTER PROCEDURE DBO.REPEX_INVOICE_RATING_RIGLA
    @XMLPARAM NTEXT AS
...
--exec REPEX_INVOICE_RATING_RIGLA N'<XML><ID_GLOBAL>65527C09-F747-45E7-8CD8-674E8E4E1637</ID_GLOBAL></XML>'