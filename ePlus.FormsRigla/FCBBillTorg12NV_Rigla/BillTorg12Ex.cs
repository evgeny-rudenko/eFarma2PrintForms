...
namespace BillTorg12NV_Rigla
{
  public class BillTorg12NV_Rigla : AbstractDocumentReport, IExternalDocumentPrintForm
	{
		...
		{
      Stream s = this.GetType().Assembly.GetManifestResourceStream("BillTorg12NV_Rigla.BillTorg12.sql");
      ...
      using (SqlDataAdapter sqlda = new SqlDataAdapter("REPEX_BILL_TORG12_NV_RIGLA", connectionString))
			{
		...
		{
			get { return "ТОРГ-12 (освобождение от уплаты НДС) (Ригла)"; }
		}
	}
}
