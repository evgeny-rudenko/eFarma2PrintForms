...
namespace FCSWaybill
{
    public class Waybill : AbstractDocumentReport, IExternalDocumentPrintForm
    {
        ...
        {
            get { return "“оварно-транспортна€ накладна€"; }
        }

        // метод дл€ создани€ хранимой процедуры по указанной строке подключени€ 
        ...
        // ћетод дл€ заполнени€ формы отчета данными, возвращающий фактически сформированный экземпл€р формы отчета
