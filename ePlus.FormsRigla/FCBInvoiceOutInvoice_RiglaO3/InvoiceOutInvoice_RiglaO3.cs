...
namespace FCBInvoiceOutInvoice_RiglaO3
{
  public class InvoiceOutInvoice_RiglaO3 : AbstractDocumentReport, IExternalDocumentPrintForm
  {
    ...
    {
        Stream s = this.GetType().Assembly.GetManifestResourceStream("FCBInvoiceOutInvoice_RiglaO3.InvoiceOutInvoice_RiglaO3.sql");
    ...
    Stream s = this.GetType().Assembly.GetManifestResourceStream("FCBInvoiceOutInvoice_RiglaO3.InvoiceOutInvoice_RiglaO3.rdlc");
    ...
    public override IReportForm GetReportForm(DataRowItem dataRowItem)
    {
      ...
      rep.BindDataSource("FCBInvoiceOutInvoice_RiglaO3_DS_Table0", 0);
      rep.BindDataSource("FCBInvoiceOutInvoice_RiglaO3_DS_Table1", 1);
      rep.BindDataSource("FCBInvoiceOutInvoice_RiglaO3_DS_Table2", 2);
