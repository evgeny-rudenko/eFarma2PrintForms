...
IF (OBJECT_ID('DBO.REPEX_INVOICE_OUT_INVOICE_RIGLA_O3') IS NULL) EXEC ('CREATE PROCEDURE DBO.REPEX_INVOICE_OUT_INVOICE_RIGLA_O3 AS RETURN')
GO
ALTER PROCEDURE DBO.REPEX_INVOICE_OUT_INVOICE_RIGLA_O3
	@XMLPARAM NTEXT AS
...
--EXEC DBO.REPEX_INVOICE_OUT_INVOICE_RIGLA_O3 N'<XML><ID_GLOBAL>972D8154-408B-40AD-A550-2F76117D4714</ID_GLOBAL></XML>'
...
EXEC DBO.REMOVE_REPORT_BY_TYPE_NAME 'InvoiceOutInvoice_RiglaO3_Mod.InvoiceOutInvoice_RiglaO3'