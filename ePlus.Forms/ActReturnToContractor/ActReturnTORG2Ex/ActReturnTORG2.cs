...
namespace ActReturnTORG2Ex {
    ...
    public class ActReturnTORG2 : ReportClass {
        
        public ActReturnTORG2() {
        }
        
        public override string ResourceName {
            get {
                return "ActReturnTORG2.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedActReturnTORG2 : Component, ICachedReport {
        
        public CachedActReturnTORG2() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            ActReturnTORG2 rpt = new ActReturnTORG2();
            rpt.Site = this.Site;
            return rpt;
        }
