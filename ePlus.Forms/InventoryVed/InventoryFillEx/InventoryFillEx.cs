...
namespace FCSInventoryFill
{
	public class InventoryFillEx : AbstractDocumentReport, IExternalDocumentPrintForm
	{
		...
		{
            Stream s = this.GetType().Assembly.GetManifestResourceStream("FCSInventoryFill.InventoryFill.sql");
		...
		void ExtractReport()
		{
            ...
            Stream s = this.GetType().Assembly.GetManifestResourceStream("FCSInventoryFill.InventoryFill.rdlc");
