...
namespace F29NInterfirmMovingNoSupplierPrices
{
	public class Movement : AbstractDocumentReport, IExternalDocumentPrintForm
	{
		...
		{
            Stream s = this.GetType().Assembly.GetManifestResourceStream("F29NInterfirmMovingNoSupplierPrices.Movement.sql");
		...
		void ExtractReport()
		{
            ...
            Stream s = this.GetType().Assembly.GetManifestResourceStream("F29NInterfirmMovingNoSupplierPrices.Movement.rdlc"); 
		...
		public override IReportForm GetReportForm(DataRowItem dataRowItem)
		{
			...
			rep.LoadData("REPEX_F29N_INTERFIRM_MOVING", doc.InnerXml);
		...
		{
			get { return "Перемещение(штрих-код)"; }
		}
	}
}
