...
namespace F29NMovementNoSupplierPrices
{
	public class Movement : AbstractDocumentReport, IExternalDocumentPrintForm
	{
		...
		{
            Stream s = this.GetType().Assembly.GetManifestResourceStream("F29NMovementNoSupplierPrices.Movement.sql");
		...
		void ExtractReport()
		{
            ...
            Stream s = this.GetType().Assembly.GetManifestResourceStream("F29NMovementNoSupplierPrices.Movement.rdlc"); 
		...
		public override IReportForm GetReportForm(DataRowItem dataRowItem)
		{
			...
			rep.LoadData("REPEX_F29N_MOVEMENT", doc.InnerXml);
