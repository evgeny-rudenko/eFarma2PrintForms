...
IF (OBJECT_ID('DBO.FN_CERT_LIST_4_REPEX_BILL_TORG12') IS NULL)	EXEC ('CREATE FUNCTION DBO.FN_CERT_LIST_4_REPEX_BILL_TORG12() RETURNS VARCHAR(4000) AS BEGIN RETURN CONVERT(VARCHAR(4000), NULL) END')
GO
ALTER FUNCTION DBO.FN_CERT_LIST_4_REPEX_BILL_TORG12(
    @ID_SERIES BIGINT
)
...
IF OBJECT_ID('DBO.REPEX_BILL_TORG12') IS NULL EXEC('CREATE PROCEDURE DBO.REPEX_BILL_TORG12 AS RETURN')
GO
ALTER PROCEDURE DBO.REPEX_BILL_TORG12(
    @XMLPARAM NTEXT
) AS
...
SELECT	
    ...
    CERTIFICATION_INFO = DBO.FN_CERT_LIST_4_REPEX_BILL_TORG12(S.ID_SERIES),
    S.BEST_BEFORE,
    S.SERIES_NUMBER
FROM BILL B
...
--exec REPEX_BILL_TORG12 '<XML><ID_GLOBAL>BB6DAA9C-E041-4626-82B3-CCEB8703A9F6</ID_GLOBAL></XML>'