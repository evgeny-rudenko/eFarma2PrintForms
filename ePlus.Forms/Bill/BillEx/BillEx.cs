...
namespace FCSBill
{
    public class BillEx : AbstractDocumentReport, IExternalDocumentPrintForm//, IExternalReportWithTags
	{
		...
		{
            Stream s = this.GetType().Assembly.GetManifestResourceStream("FCSBill.Bill.sql");
		...
		void ExtractReport()
		{
            ...
            Stream s = this.GetType().Assembly.GetManifestResourceStream("FCSBill.Bill.rdlc");
