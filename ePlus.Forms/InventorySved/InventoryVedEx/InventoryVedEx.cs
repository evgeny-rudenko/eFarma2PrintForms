...
namespace FCBInventoryVed
{
	public class InventoryVedEx : AbstractDocumentReport, IExternalDocumentPrintForm
	{
		...
		{
            Stream s = this.GetType().Assembly.GetManifestResourceStream("FCBInventoryVed.InventoryVed.sql");
		...
		void ExtractReport()
		{
            ...
            Stream s = this.GetType().Assembly.GetManifestResourceStream("FCBInventoryVed.InventoryVed.rdlc");
		...
		public override IReportForm GetReportForm(DataRowItem dataRowItem)
		{
            ...
            rep.LoadData("DBO.REPEX_INVENTORY_VED", doc.InnerXml);
			rep.BindDataSource("InventoryVed_DS_Table0", 0);
			rep.BindDataSource("InventoryVed_DS_Table1", 1);
		...
		{
			get { return "Инвентаризационная ведомость"; }
		}
	}
}
