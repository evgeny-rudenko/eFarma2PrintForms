...
namespace FCSInventoryVedAll
{
	public class InventoryVedAllEx : AbstractDocumentReport, IExternalDocumentPrintForm
	{
		...
		{
            Stream s = this.GetType().Assembly.GetManifestResourceStream("FCSInventoryVedAll.InventoryVedAll.sql");
		...
		void ExtractReport()
		{
            ...
            Stream s = this.GetType().Assembly.GetManifestResourceStream("FCSInventoryVedAll.InventoryVedAll.rdlc");
		...
		public override IReportForm GetReportForm(DataRowItem dataRowItem)
		{
			...
			rep.BindDataSource("InventoryVedAll_DS_Table0", 0);
			rep.BindDataSource("InventoryVedAll_DS_Table1", 1);
			rep.BindDataSource("InventoryVedAll_DS_Table2", 2);
		...
		{
			get { return "Инвентаризационная ведомость (полная)"; }
		}
	}
}
