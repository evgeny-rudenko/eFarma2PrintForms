...
IF (OBJECT_ID('DBO.REPEX_STOCK_GOODS_BY_LOT_EXT') IS NULL) EXEC ('CREATE PROCEDURE DBO.REPEX_STOCK_GOODS_BY_LOT_EXT AS RETURN')
GO
ALTER PROCEDURE DBO.REPEX_STOCK_GOODS_BY_LOT_EXT
    @XMLPARAM NTEXT
AS
...
GO
/*
exec DBO.REPEX_STOCK_GOODS_BY_LOT_EXT '<XML>
