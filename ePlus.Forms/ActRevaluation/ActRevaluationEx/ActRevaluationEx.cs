...
namespace FCSActRevaluation
{
	public class ActRevaluationEx : AbstractDocumentReport, IExternalDocumentPrintForm
	{
		...
		{
            Stream s = this.GetType().Assembly.GetManifestResourceStream("FCSActRevaluation.ActRevaluation.sql");
		...
		void ExtractReport()
		{
            ...
            Stream s = this.GetType().Assembly.GetManifestResourceStream("FCSActRevaluation.ActRevaluation.rdlc");
