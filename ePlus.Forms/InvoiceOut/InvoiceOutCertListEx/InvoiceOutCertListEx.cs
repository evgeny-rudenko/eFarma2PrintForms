...
namespace FCSInvoiceOutCertList
{
	public class InvoiceOutCertListEx : AbstractDocumentReport, IExternalDocumentPrintForm
	{
		...
		{
            Stream s = this.GetType().Assembly.GetManifestResourceStream("FCSInvoiceOutCertList.InvoiceOutCertList.sql");
		...
		void ExtractReport()
		{
            ...
            Stream s = this.GetType().Assembly.GetManifestResourceStream("FCSInvoiceOutCertList.InvoiceOutCertList.rdlc");
