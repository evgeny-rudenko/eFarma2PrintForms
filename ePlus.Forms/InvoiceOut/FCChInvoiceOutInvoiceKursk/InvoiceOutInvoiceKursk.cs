...
namespace InvoiceOutInvoiceKursk
{
	public class InvoiceOutInvoiceKursk : AbstractDocumentPrintForm
	{
		protected override IReportForm Print(DataRowItem dataRowItem, string[] reportFiles)
		{
			 ...
			 */
			rep.ReportPath = Path.Combine(Path.Combine(folderPath, CACHE_FOLDER), "InvoiceOutInvoiceKursk.rdlc");
			...
			string number;
			using (var paramForm = new InvoiceOutInvoiceKurskForm())
			{
