...
namespace FCBInvoiceOutPriceNegotiationProtocolZNVLS
{
  public class InvoiceOutPriceNegotiationProtocolZNVLS : AbstractDocumentReport, IExternalDocumentPrintForm
  {
    ...
    {
        Stream s = this.GetType().Assembly.GetManifestResourceStream("FCBInvoiceOutPriceNegotiationProtocolZNVLS.InvoiceOutPriceNegotiationProtocolZNVLS.sql");
    ...
    Stream s = this.GetType().Assembly.GetManifestResourceStream("FCBInvoiceOutPriceNegotiationProtocolZNVLS.InvoiceOutPriceNegotiationProtocolZNVLS.rdlc");
    ...
    public override IReportForm GetReportForm(DataRowItem dataRowItem)
    {
      ...
      rep.LoadData("REPEX_INVOICE_OUT_PRICE_NEGOTIATION_PROTOCOL_ZNVLS", doc.InnerXml);
    ...
    {
      get { return "Протокол согласования цен поставки ЖНВЛС"; }
    }
  }
}
