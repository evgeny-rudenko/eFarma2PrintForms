...
SELECT
	...
	COMPANY_NAME = 
		CASE 
			WHEN B.ID_BILL_GLOBAL IS NULL THEN CASE 
												 WHEN (S.LEGAL_PERS_SHORT IS NULL OR S.LEGAL_PERS_SHORT = '') THEN S.LEGAL_PERS 
												 ELSE S.LEGAL_PERS_SHORT 
											   END 
			ELSE CASE 
					WHEN (BC.LEGAL_PERS_SHORT IS NULL OR BC.LEGAL_PERS_SHORT = '') THEN BC.LEGAL_PERS
					ELSE BC.LEGAL_PERS_SHORT 
				 END 
		END,
