...
IF OBJECT_ID('DBO.REPEX_INVOICE_OUT_PRICE_NEGOTIATION_PROTOCOL') IS NULL EXEC('CREATE PROCEDURE DBO.REPEX_INVOICE_OUT_PRICE_NEGOTIATION_PROTOCOL AS RETURN')
GO
ALTER PROCEDURE DBO.REPEX_INVOICE_OUT_PRICE_NEGOTIATION_PROTOCOL
    @XMLPARAM NTEXT AS
...
WHERE II.ID_INVOICE_OUT_GLOBAL = @ID_GLOBAL AND 
	I.STATE IN ('PROC', 'SAVE') AND G.IMPORTANT = 0
ORDER BY G.NAME

RETURN 0
GO

--exec DBO.REPEX_INVOICE_OUT_PRICE_NEGOTIATION_PROTOCOL N'<XML><ID_GLOBAL>59367F51-CCB4-4F01-87CE-566DFD4A3BD5</ID_GLOBAL></XML>'
...
EXEC DBO.REMOVE_REPORT_BY_TYPE_NAME 'InvoiceOutPriceNegotiationProtocol.InvoiceOutPriceNegotiationProtocol'