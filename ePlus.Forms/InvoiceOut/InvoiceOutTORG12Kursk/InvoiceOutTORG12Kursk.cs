...
namespace FCSInvoiceOutTORG12Kursk
{
	public class FCSInvoiceOutTORG12Kursk : AbstractDocumentPrintForm, IExternalDocumentPrintForm
	{
		protected override IReportForm Print(DataRowItem dataRowItem, string[] reportFiles)
		{
			...
			rep.ReportPath = Path.Combine(Path.Combine(folderPath, CACHE_FOLDER), "InvoiceTORG12Kursk.rdlc");
		...
		{
			get { return "ТОРГ-12 (альбом.) (Курск)"; }
		}
	}
}
