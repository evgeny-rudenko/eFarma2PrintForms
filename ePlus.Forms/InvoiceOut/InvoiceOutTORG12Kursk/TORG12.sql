...
SELECT TOP 1
	...
	SUPPLIER_DESCRIPT =
		ISNULL(ISNULL(SUP.NAME, SUP.FULL_NAME),'') +
	...
	STORE_NAME = SUP.NAME,
	CUSTOMER_DESCRIPT = 
		ISNULL(ISNULL(CONT.NAME, CONT.FULL_NAME),'')+
	...
	SUPPLIER_NAME =  ISNULL(SUP.LEGAL_PERS_SHORT, '')  +
		...
		COALESCE(' БИК:' + SUP.BIK, '')+
		COALESCE(' к/с:' + SUP.CORR_ACCOUNT, ''),
	PAYER_NAME = ISNULL(ISNULL(PAY.NAME, PAY.FULL_NAME),'')+
	...
	INVICE_DATE = I.DATE,
	SUPPLIER_DIR_FIO = SUP.DIRECTOR_FIO
		--select * 
FROM INVOICE_OUT I
