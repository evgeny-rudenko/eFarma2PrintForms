...
namespace FCChInvoiceOutTORG12
{
...

	{
        protected override IReportForm Print(DataRowItem dataRowItem, string[] reportFiles)
		{
            ...
            rep.ReportPath = Path.Combine(Path.Combine(folderPath, CACHE_FOLDER), "FCChInvoiceOutTORG12.rdlc");
		...
		{
			get { return "ТОРГ-12 альбом. (полные наименования)"; }
		}
	}
}
