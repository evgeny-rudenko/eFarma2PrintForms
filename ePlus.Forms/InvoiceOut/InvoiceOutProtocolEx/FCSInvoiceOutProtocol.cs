...
{
    public class FCSInvoiceOutProtocol : AbstractDocumentReport, IExternalDocumentPrintForm
	{
		...
		{
            Stream s = this.GetType().Assembly.GetManifestResourceStream("FCSInvoiceOutProtocol.InvoiceOutProtocol.sql");
		...
		void ExtractReport()
		{
            ...
            Stream s = this.GetType().Assembly.GetManifestResourceStream("FCSInvoiceOutProtocol.InvoiceOutProtocol.rdlc");
