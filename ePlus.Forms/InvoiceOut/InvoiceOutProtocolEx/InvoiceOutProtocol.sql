...
AS
    ...
    SELECT 
        ...
        VAT_SUP = L.VAT_SUP,
        ADPRICE = IOI.ADPRICE_SAL, --L.ADPRICE_SAL,--((L.PRICE_SAL - L.PVAT_SUP)/ (L.PRICE_SUP-L.PVAT_SUP))*100-100,
        PRICE_SAL = IOI.PRICE_SAL * CONVERT(MONEY, SR.DENOMINATOR) / SR.NUMERATOR,
        SUM_SAL = IOI.PRICE_SAL * QUANTITY
    INTO #ITEMS
...
--exec REPEX_INVOICE_OUT_PROTOCOL N'<XML><ID_GLOBAL>2AD3308A-7EEE-4AFD-86EA-19151D5AB532</ID_GLOBAL></XML>'
