...
namespace FCSInvoiceOutPTORG12
{
	public class InvoiceOutPTORG12Ex : AbstractDocumentPrintForm, IExternalDocumentPrintForm
	{
		void CreateStoredProc(string connectionString)
		{
            Stream s = this.GetType().Assembly.GetManifestResourceStream("FCSInvoiceOutPTORG12.TORG12.sql");
        ...
        void ExtractReport()
        {
            ...
            Stream s = this.GetType().Assembly.GetManifestResourceStream("FCSInvoiceOutPTORG12.InvoiceOutPTORG12Ex.rdlc");
