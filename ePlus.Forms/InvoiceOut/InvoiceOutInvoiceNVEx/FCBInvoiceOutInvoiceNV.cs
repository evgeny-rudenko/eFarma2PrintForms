...
namespace FCBInvoiceOutInvoiceNV
{
    public class FCBInvoiceOutInvoiceNV : AbstractDocumentReport, IExternalDocumentPrintForm
	{
		...
		{
            Stream s = this.GetType().Assembly.GetManifestResourceStream("FCBInvoiceOutInvoiceNV.InvoiceOutInvoiceNV.sql");
		...
		void ExtractReport()
		{
            ...
            Stream s = this.GetType().Assembly.GetManifestResourceStream("FCBInvoiceOutInvoiceNV.InvoiceOutInvoiceNV.rdlc");
            ...
            if (!Directory.Exists(cachePath))
                Directory.CreateDirectory(cachePath);
            s = this.GetType().Assembly.GetManifestResourceStream("FCBInvoiceOutInvoiceNV.InvoiceOutInvoiceNVAfter240112.rdlc");
            using (StreamReader sr = new StreamReader(s))
            {
