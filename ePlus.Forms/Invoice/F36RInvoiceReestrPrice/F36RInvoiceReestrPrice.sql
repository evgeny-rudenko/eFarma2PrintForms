...
IF OBJECT_ID('[REPEX_F36RInvoiceReestrPrice]') IS NULL EXEC('CREATE PROCEDURE [REPEX_F36RInvoiceReestrPrice] AS RETURN')
GO
ALTER PROCEDURE REPEX_F36RInvoiceReestrPrice
	(@XMLPARAM NTEXT) AS
