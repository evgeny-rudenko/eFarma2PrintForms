...
namespace FCSInvoice
{
	public class InvoiceEx : AbstractDocumentReport, IExternalDocumentPrintForm
	{
		...
		{
            Stream s = this.GetType().Assembly.GetManifestResourceStream("FCSInvoice.Invoice.sql");
		...
		void ExtractReport()
		{
            ...
            Stream s = this.GetType().Assembly.GetManifestResourceStream("FCSInvoice.Invoice.rdlc");
		...
		public override IReportForm GetReportForm(DataRowItem dataRowItem)
		{
            ...
            ReportParameter p3 = new ReportParameter("VER_DLL", System.Reflection.Assembly.GetExecutingAssembly().ManifestModule.ScopeName);
            rep.ReportViewer.LocalReport.SetParameters(new ReportParameter[] { p1, p2, p3});
