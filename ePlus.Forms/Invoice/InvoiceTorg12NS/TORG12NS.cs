...
{
  public class TORG12Ex : AbstractDocumentReport, IExternalDocumentPrintForm
  {
    ...
    {
      Stream s = this.GetType().Assembly.GetManifestResourceStream("InvoiceTorg12NS.TORG12.sql");
    ...
    public override IReportForm GetReportForm(DataRowItem dataRowItem)
    {
      ...
      using (SqlDataAdapter sqlda = new SqlDataAdapter("REPEX_TORG12", connectionString))
      {
      ...
      InvoiceTorg12NS report = new InvoiceTorg12NS();
