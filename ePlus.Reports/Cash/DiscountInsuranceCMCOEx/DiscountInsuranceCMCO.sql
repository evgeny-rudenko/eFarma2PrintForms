...
IF (OBJECT_ID('DBO.REPEX_DISCOUNT_INSURANCE_CMCO') IS NULL) EXEC ('CREATE PROCEDURE DBO.REPEX_DISCOUNT_INSURANCE_CMCO AS RETURN')
GO
ALTER PROCEDURE DBO.REPEX_DISCOUNT_INSURANCE_CMCO
    @XMLPARAM NTEXT
AS
