...
IF OBJECT_ID('DBO.REPEX_TRUST_LETTER_AP25') IS NULL EXEC('CREATE PROCEDURE DBO.REPEX_TRUST_LETTER_AP25 AS RETURN')
GO

ALTER PROCEDURE DBO.REPEX_TRUST_LETTER_AP25
    @XMLPARAM NTEXT AS
...
FROM OPENXML(@HDOC, '/XML') WITH(
	...
	DATE_SH_FR DATETIME 'DATE_SHIP_FROM',
	DATE_SH_TO DATETIME 'DATE_SHIP_TO'
)
