...
IF OBJECT_ID('DBO.REPEX_MOVE_GOODS_NN') IS NULL BEGIN EXEC('CREATE PROCEDURE DBO.REPEX_MOVE_GOODS_NN AS RETURN') END
GO
ALTER PROCEDURE DBO.REPEX_MOVE_GOODS_NN
    @XMLPARAM NTEXT AS
...
IF OBJECT_ID('DBO.REPEX_MOVE_GOODS_NN_VAT_SUP') IS NULL BEGIN EXEC('CREATE PROCEDURE DBO.REPEX_MOVE_GOODS_NN_VAT_SUP AS RETURN') END
GO
ALTER PROCEDURE DBO.REPEX_MOVE_GOODS_NN_VAT_SUP
    @XMLPARAM NTEXT AS
...
/*EXEC REPEX_MOVE_GOODS_NN_VAT_SUP N'
<XML>
	<DATE_FR>2011-01-28T10:13:30.781</DATE_FR>
	<DATE_TO>2011-01-28T10:13:30.781</DATE_TO>
	<MOV>1</MOV>
...
IF OBJECT_ID('DBO.REPEX_MOVE_GOODS_NN_VAT_SAL') IS NULL BEGIN EXEC('CREATE PROCEDURE DBO.REPEX_MOVE_GOODS_NN_VAT_SAL AS RETURN') END
GO
ALTER PROCEDURE DBO.REPEX_MOVE_GOODS_NN_VAT_SAL
    @XMLPARAM NTEXT AS
...
/*
EXEC REPEX_MOVE_GOODS_NN_VAT_SAL N'
<XML>
...
*/
/*
exec REPEX_MOVE_GOODS_NN @xmlParam=N'<XML>
...
EXEC DBO.REMOVE_REPORT_BY_TYPE_NAME 'MoveGoodsEx.MoveGoodsParams_NN'
