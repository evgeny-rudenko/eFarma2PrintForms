...
namespace RCBMoveGoods
{
    ...
    private string SettingsFilePath
    {
      ...
      rep.BindDataSource("MoveGoods_DS_Table3", 2);

			if (repTypeComboBox.SelectedIndex != 0)
			{
				rep.BindDataSource("MoveGoods_DS_Table2", 3);
			}
    ...
    private void MoveGoodsParams_FormClosed(object sender, FormClosedEventArgs e)
    {
      SaveSettings();
    }
	}
