...
{
	public partial class R36RGoodsRest : ExternalReportForm, IExternalReportFormMethods
	{
		public R36RGoodsRest()
		{
			InitializeComponent();
		}
    ...
    private string SettingsFilePath
    {
      get
      {
		...
		public void Print(string[] reportFiles)
		{
            ...
            Utils.AddNode(root, "IS_GROUPS", cbGroups.Checked);
            ...
            rep.LoadData("REPEX_R36RGoodsRest", doc.InnerXml);
            rep.BindDataSource("R36RGoodsRest_DS_Table", 0);
		...
		{
			get { return "Остаток товара (Оренбург)"; }
		}
