...
namespace Inv3 {
    ...
    public class Inv3Report : ReportClass {
    ...
    public class CachedInv3Report : Component, ICachedReport {
        
        public CachedInv3Report() {
        }
