...
SELECT
    L.ID_GOODS,
	PRICE = CASE WHEN @CONST = 'SAL' THEN L.PRICE_SAL ELSE L.PRICE_SUP END,
...
GROUP BY L.ID_GOODS, 
    ...
    (CASE WHEN @CONST = 'SAL' THEN L.PRICE_SAL ELSE L.PRICE_SUP END)
...
SELECT 
    II.ID_GOODS, 
	PRICE = CASE WHEN @CONST = 'SAL' THEN II.PRICE_SAL ELSE II.PRICE_SUP END,
...
GROUP BY II.ID_GOODS, 
    ...
    (CASE WHEN @CONST = 'SAL' THEN II.PRICE_SAL ELSE II.PRICE_SUP END)
