...
{
	public class MovementTORG13KUZEx : AbstractDocumentReport, IExternalDocumentPrintForm
	{
		...
		{
			Stream s = this.GetType().Assembly.GetManifestResourceStream("MovementTORG13KUZEx.TORG13.sql");
		...
		public override IReportForm GetReportForm(DataRowItem dataRowItem)
		{
			...
			reportForm.SetDataSource("Перемещение: ТОРГ-13 [Кузбасc]", ds, report);
			return reportForm;
		}
		...
		{
			get { return "Перемещение: ТОРГ-13 [Кузбасc]"; }
		}
	}
}
