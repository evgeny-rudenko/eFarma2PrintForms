...
namespace Inv3
{
	public class Inv3Form : AbstractDocumentReport, IExternalDocumentPrintForm
	{
		...
		{
			Stream s = this.GetType().Assembly.GetManifestResourceStream("Inv3.Inv3.sql");
		...
		public override IReportForm GetReportForm(DataRowItem dataRowItem)
		{
			...
			Inv3Report report = new Inv3Report();
		...
		{
			get { return "ИНВ-3 Кузбасс Инвентаризационная опись товарно-материальных ценностей"; }
		}
	}
}
