...
namespace ServicePriceListEx
{
	public class ServicePriceListEx : AbstractDocumentReport, IExternalDocumentPrintForm
	{
		...
		{
			Stream s = this.GetType().Assembly.GetManifestResourceStream("ServicePriceListEx.ServicePriceList.sql");
		...
		void ExtractReport()
		{
			...
			Stream s = this.GetType().Assembly.GetManifestResourceStream("ServicePriceListEx.ServicePriceList.rdlc");
