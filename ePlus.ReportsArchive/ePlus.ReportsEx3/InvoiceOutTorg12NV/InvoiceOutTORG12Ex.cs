...
namespace InvoiceOutTorg12NV
{
	public class InvoiceOutTorg12NV : AbstractDocumentReport, IExternalDocumentPrintForm
	{
		...
		{
			Stream s = this.GetType().Assembly.GetManifestResourceStream("InvoiceOutTorg12NV.TORG12.sql");
		...
		{
			get { return "Расходные документы: ТОРГ-12 (освобождение от уплаты НДС) (альбом.)"; }
		}
	}
}
