...
namespace InvoiceTorg12NV
{
	public class TORG12Ex : AbstractDocumentReport, IExternalDocumentPrintForm
	{
		...
		{
			Stream s = this.GetType().Assembly.GetManifestResourceStream("InvoiceTorg12NV.TORG12.sql");
		...
		{
			get { return "Приходные документы: ТОРГ-12 (освобождение от уплаты НДС)"; }
		}
	}
}
