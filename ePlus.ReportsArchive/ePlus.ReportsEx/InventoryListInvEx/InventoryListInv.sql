...
IF OBJECT_ID('REPEX_INVENTORY_LISTINV') IS NULL EXEC('CREATE PROCEDURE REPEX_INVENTORY_LISTINV AS RETURN')
GO
ALTER PROCEDURE REPEX_INVENTORY_LISTINV
    @XMLPARAM NTEXT
AS
...
SELECT TOP 1
    DOC_DATE = I.DOC_DATE,
    DOC_NUM = I.DOC_NUM,
    DOC_NAME = 'Инвентаризационная опись' + CHAR(10) + 'товарно-материальных ценностей',
    STORE_NAME = S.NAME,
