...
<XML>
	<DATE_FR>2009-07-06T00:00:00.000</DATE_FR>
	<DATE_TO>2009-07-08T00:00:00.000</DATE_TO>
...
SELECT
    ...
    SUM_ACC0 = CASE WHEN DM.VAT_RATE = 0 THEN CASE WHEN DM.ID_TABLE=19 AND CODE_OP='DIS' THEN -1 ELSE 1 END * SUM_ACC * DM.SIGN_OP ELSE 0 END,
    SUM_ACC10 = CASE WHEN DM.VAT_RATE = 10 THEN CASE WHEN DM.ID_TABLE=19 AND CODE_OP='DIS' THEN -1 ELSE 1 END * SUM_ACC * DM.SIGN_OP ELSE 0 END,
    SUM_ACC18 = CASE WHEN DM.VAT_RATE = 18 THEN CASE WHEN DM.ID_TABLE=19 AND CODE_OP='DIS' THEN -1 ELSE 1 END * SUM_ACC * DM.SIGN_OP ELSE 0 END,
    ...
    SVAT_ACC10 = CASE WHEN DM.VAT_RATE = 10 THEN CASE WHEN DM.ID_TABLE=19 AND CODE_OP='DIS' THEN -1 ELSE 1 END * SVAT_ACC * DM.SIGN_OP ELSE 0 END,
    SVAT_ACC18 = CASE WHEN DM.VAT_RATE = 18 THEN CASE WHEN DM.ID_TABLE=19 AND CODE_OP='DIS' THEN -1 ELSE 1 END * SVAT_ACC * DM.SIGN_OP ELSE 0 END	
FROM DOC_MOVEMENT DM
WHERE DATE_OP < @DATE_FR
...
<XML>
	<DATE_FR>2009-09-04T00:00:00.000</DATE_FR>
	<DATE_TO>2009-09-04T00:00:00.000</DATE_TO>
	<NO_DETAIL>0</NO_DETAIL>
	<SHOW_ADD>1</SHOW_ADD>
	<SHOW_SUB>1</SHOW_SUB>
	<SORT_DOC>1</SORT_DOC>
...
<XML>
	...
	<DATE_TO>2009-09-01T00:00:00.000</DATE_TO>
	<NO_DETAIL>0</NO_DETAIL>
	<SHOW_ADD>1</SHOW_ADD>
	<SHOW_SUB>1</SHOW_SUB>
	<SORT_DOC>1</SORT_DOC>
...
SELECT
    ...
    SUM_ACC0 = CASE WHEN DM.VAT_RATE_SAL = 0 THEN CASE WHEN DM.ID_TABLE=19 AND CODE_OP='DIS' THEN -1 ELSE 1 END * SUM_ACC * DM.SIGN_OP ELSE 0 END,
    SUM_ACC10 = CASE WHEN DM.VAT_RATE_SAL = 10 THEN CASE WHEN DM.ID_TABLE=19 AND CODE_OP='DIS' THEN -1 ELSE 1 END * SUM_ACC * DM.SIGN_OP ELSE 0 END,
    SUM_ACC18 = CASE WHEN DM.VAT_RATE_SAL = 18 THEN CASE WHEN DM.ID_TABLE=19 AND CODE_OP='DIS' THEN -1 ELSE 1 END * SUM_ACC * DM.SIGN_OP ELSE 0 END,
    ...
    SVAT_ACC10 = CASE WHEN DM.VAT_RATE_SAL = 10 THEN CASE WHEN DM.ID_TABLE=19 AND CODE_OP='DIS' THEN -1 ELSE 1 END * SVAT_ACC * DM.SIGN_OP ELSE 0 END,
    SVAT_ACC18 = CASE WHEN DM.VAT_RATE_SAL = 18 THEN CASE WHEN DM.ID_TABLE=19 AND CODE_OP='DIS' THEN -1 ELSE 1 END * SVAT_ACC * DM.SIGN_OP ELSE 0 END	
FROM DOC_MOVEMENT DM
WHERE DATE_OP < @DATE_FR
    AND (DM.ID_STORE IS NOT NULL AND DM.ID_STORE IN (SELECT ID_STORE FROM #STORE))
...
<XML>
	<DATE_FR>2009-08-01T00:00:00.000</DATE_FR>
