...
namespace ActReturnToContractorAdvancedEx
{
	public class ActReturnToContractorAdvancedEx : AbstractDocumentReport, IExternalDocumentPrintForm
	{
		...
		{
			Stream s = this.GetType().Assembly.GetManifestResourceStream("ActReturnToContractorAdvancedEx.ActReturnToContractorAdvanced.sql");
		...
		void ExtractReport()
		{
			...
			Stream s = this.GetType().Assembly.GetManifestResourceStream("ActReturnToContractorAdvancedEx.ActReturnToContractorAdvanced.rdlc");
