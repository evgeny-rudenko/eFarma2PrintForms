IF (OBJECT_ID('REP_GOODS_REPORTS_DISCOUNT_GROUP_GR_EX') IS NULL) EXEC ('CREATE PROCEDURE REP_GOODS_REPORTS_DISCOUNT_GROUP_GR_EX AS RETURN')
GO
ALTER PROCEDURE REP_GOODS_REPORTS_DISCOUNT_GROUP_GR_EX
    @XMLPARAM NTEXT
AS
