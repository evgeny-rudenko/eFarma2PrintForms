IF (OBJECT_ID('REP_GOODS_REPORTS_DISCOUNT_GROUP') IS NULL) EXEC ('CREATE PROCEDURE REP_GOODS_REPORTS_DISCOUNT_GROUP AS RETURN')
GO
ALTER PROCEDURE REP_GOODS_REPORTS_DISCOUNT_GROUP
    @XMLPARAM NTEXT
AS
