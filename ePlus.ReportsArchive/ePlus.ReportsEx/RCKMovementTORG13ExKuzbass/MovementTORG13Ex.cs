...
namespace RCKMovementTORG13ExKuzbass
{
	public class RCKMovementTORG13ExKuzbass : AbstractDocumentReport, IExternalDocumentPrintForm
	{
		...
		{
			Stream s = this.GetType().Assembly.GetManifestResourceStream("RCKMovementTORG13ExKuzbass.TORG13.sql");
		...
		public override IReportForm GetReportForm(DataRowItem dataRowItem)
		{
			...
			reportForm.SetDataSource("Перемещение: ТОРГ-13", ds, report);
			return reportForm;
		}
		...
		{
			get { return "Перемещение: ТОРГ-13"; }
		}
	}
}
