...
IF OBJECT_ID('REPEX_LIST_RETURN_TO_CONTRACTOR') IS NULL EXEC('CREATE PROCEDURE REPEX_LIST_RETURN_TO_CONTRACTOR AS RETURN')
GO
ALTER  PROCEDURE REPEX_LIST_RETURN_TO_CONTRACTOR
	@XMLPARAM NTEXT AS
