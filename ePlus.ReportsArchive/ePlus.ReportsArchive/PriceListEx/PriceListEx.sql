...
-------------------------------------------------------------------------------
IF OBJECT_ID('DBO.REP_PRICELISTNEW_EX') IS NULL EXEC('CREATE PROCEDURE DBO.REP_PRICELISTNEW_EX AS RETURN')
GO
SET QUOTED_IDENTIFIER OFF 
GO
SET ANSI_NULLS ON 
...
ALTER  PROCEDURE DBO.REP_PRICELISTNEW_EX
	(@XMLPARAM NTEXT) 
AS
...
--exec rep_PriceListNew_Ex @xmlParam = N'<XML><DATE_OST>2007-02-21T10:21:01.125</DATE_OST><SORT>0</SORT></XML>'
