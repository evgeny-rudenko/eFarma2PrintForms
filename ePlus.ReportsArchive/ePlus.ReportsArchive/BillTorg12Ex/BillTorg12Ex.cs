...
namespace BillTorg12Ex
{
	public class BillTorg12Ex : AbstractDocumentReport, IExternalDocumentPrintForm
	{
		...
		{
			Stream s = this.GetType().Assembly.GetManifestResourceStream("BillTorg12Ex.BillTorg12.sql");
		...
		public override IReportForm GetReportForm(DataRowItem dataRowItem)
		{
			...
			BillTorg12 report = new BillTorg12();
		...
		{
			get { return "Выписка счетов: ТОРГ-12"; }
		}
	}
}
