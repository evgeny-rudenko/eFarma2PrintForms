...
SELECT
	...
	CONTRACTOR_PRICE_PER_UNIT = BI.PRICE_SAL,
	SUM_CONTRACTOR_PRICE = (BI.PRICE_SAL - BI.PVAT_SAL) * BI.QUANTITY,
	VAT_RATE = CASE WHEN BI.PVAT_SAL * BI.QUANTITY  = 0 THEN CAST('Без НДС' AS VARCHAR(10)) ELSE CAST(L.VAT_SAL AS VARCHAR(10)) END,
...
FROM BILL B
	...
	LEFT JOIN CONTRACTOR PAY ON PAY.ID_CONTRACTOR = B.ID_CONTRACTOR_PAY
WHERE B.ID_BILL_GLOBAL = @ID_GLOBAL

RETURN 0
GO

--exec REPEX_BILL_TORG12 '<XML><ID_GLOBAL>C6E41B77-EA63-4212-86BF-BB03866243AA</ID_GLOBAL></XML>'