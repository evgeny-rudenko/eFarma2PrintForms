...
namespace InvoiceOutBillEx
{
	public class InvoiceOutBillEx : AbstractDocumentReport, IExternalDocumentPrintForm
	{
		...
		{
			Stream s = this.GetType().Assembly.GetManifestResourceStream("InvoiceOutBillEx.InvoiceOutBill.sql");
		...
		void ExtractReport()
		{
			...
			Stream s = this.GetType().Assembly.GetManifestResourceStream("InvoiceOutBillEx.InvoiceOutBill.rdlc");
		...
		public override IReportForm GetReportForm(DataRowItem dataRowItem)
		{
			...
			rep.ReportPath = Path.Combine(Path.Combine(folderPath, CACHE_FOLDER), "InvoiceOutBill.rdlc");
		...
		{
			get { return "Расходные документы: Счет"; }
		}
