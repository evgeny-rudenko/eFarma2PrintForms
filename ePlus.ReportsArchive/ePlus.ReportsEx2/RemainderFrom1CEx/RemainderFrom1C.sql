...
IF OBJECT_ID('DBO.REPEX_REMAINDER_FROM_1C') IS NULL EXEC('CREATE PROCEDURE DBO.REPEX_REMAINDER_FROM_1C AS RETURN')
GO
ALTER  PROCEDURE DBO.REPEX_REMAINDER_FROM_1C
    @XMLPARAM NTEXT AS
...
IF @NO_DETAIL <> 1 BEGIN
    ...
    FROM MV_LOT_MOVEMENT LM
        ...
        LEFT JOIN PRODUCER PROD ON PROD.ID_PRODUCER = LM.ID_PRODUCER
    WHERE LM.ID_TABLE = 2
...
/*
exec REPEX_REMAINDER_FROM_1C N'
<XML>
<DATE_FR>2008-01-01T00:00:00.000</DATE_FR>
<DATE_TO>2009-03-13T00:00:00.000</DATE_TO>
