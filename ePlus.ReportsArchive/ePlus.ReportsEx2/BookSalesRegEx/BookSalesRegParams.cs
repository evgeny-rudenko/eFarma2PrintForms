...
{
	public partial class BookSalesRegParams : ExternalReportForm, IExternalReportFormMethods
	{
		public BookSalesRegParams()
		{
			InitializeComponent();
			ucContractors.AllowSaveState = true;
			ClearValues();
		}
		...
		public void Print(string[] reportFiles)
		{
			...
			{
				MessageBox.Show("Ќе выбран(ы) продавец(ы)!", "е‘арма", MessageBoxButtons.OK, MessageBoxIcon.Warning);
				return;
			}
			...
			Utils.AddNode(root, "WITH_DISCOUNT", discountCheckBox.Checked ? "1" : "0");
			...
			rep.LoadData("REPEX_BOOK_SALES_RUM", doc.InnerXml);
