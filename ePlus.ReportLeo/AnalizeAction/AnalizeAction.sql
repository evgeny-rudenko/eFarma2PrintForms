IF (OBJECT_ID('[REPEX_ANALIZE_ACTION]') IS NULL) EXEC ('CREATE PROCEDURE [REPEX_ANALIZE_ACTION] AS RETURN')
GO
ALTER PROCEDURE [dbo].[REPEX_ANALIZE_ACTION]
    @XMLPARAM NTEXT
AS
DECLARE @HDOC INT
