...
namespace Crf70
{
    public partial class Crf70Form : ExternalReportForm, IExternalReportFormMethods
    {
        public Crf70Form()
        {
            InitializeComponent();
            Text = "Сведения об обеспечении отдельных категорий граждан";
        ...
        {
            get { return "Сведения об обеспечении отдельных категорий граждан"; }
        }
        ...
        public void Print(string[] reportFiles)
        {
            ...
            rep.LoadData("REPEX_CRF_70", doc.InnerXml);
            ...
            rep.BindDataSource("Crf70_DS_Table", 0);
