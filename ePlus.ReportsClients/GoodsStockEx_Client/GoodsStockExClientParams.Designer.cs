...
{
  partial class GoodsStockExClientParams
	{
		/// <summary>
		...
		{
      System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(GoodsStockExClientParams));
			...
			this.exCheckBox = new System.Windows.Forms.CheckBox();
			...
			// bOK
			// 
			this.bOK.Location = new System.Drawing.Point(485, 3);
			// 
			// bClose
			// 
			this.bClose.Location = new System.Drawing.Point(560, 3);
			// 
			// panel1
			// 
			...
			this.filtersTabContol.Location = new System.Drawing.Point(12, 74);
			...
			this.filtersLabel.Location = new System.Drawing.Point(16, 271);
			...
			this.filtersDataGridView.Location = new System.Drawing.Point(12, 299);
            ...
            "Альбомный",
            "Краткая форма",
            "Краткая форма по товарам"});
			this.typeComboBox.Location = new System.Drawing.Point(87, 37);
			this.typeComboBox.Name = "typeComboBox";
			this.typeComboBox.Size = new System.Drawing.Size(280, 21);
			this.typeComboBox.TabIndex = 108;
			this.typeComboBox.SelectedIndexChanged += new System.EventHandler(this.typeComboBox_SelectedIndexChanged);
			// 
			// codeCheckBox
			// 
			this.codeCheckBox.AutoSize = true;
			this.codeCheckBox.Location = new System.Drawing.Point(12, 454);
			this.codeCheckBox.Name = "codeCheckBox";
			this.codeCheckBox.Size = new System.Drawing.Size(147, 17);
			this.codeCheckBox.TabIndex = 109;
			this.codeCheckBox.Text = "Отображать код товара";
			this.codeCheckBox.UseVisualStyleBackColor = true;
			// 
			// exCheckBox
			// 
			this.exCheckBox.AutoSize = true;
			this.exCheckBox.Location = new System.Drawing.Point(174, 454);
			this.exCheckBox.Name = "exCheckBox";
			this.exCheckBox.Size = new System.Drawing.Size(218, 17);
			this.exCheckBox.TabIndex = 110;
			this.exCheckBox.Text = "Выводить нулевые остатки в таблице";
			this.exCheckBox.UseVisualStyleBackColor = true;
			// 
			...
			this.Controls.Add(this.exCheckBox);
			...
			this.FormClosed += new System.Windows.Forms.FormClosedEventHandler(this.InvoiceRemainsParams_FormClosed);
			...
			this.Controls.SetChildIndex(this.exCheckBox, 0);
		...
		private System.Windows.Forms.CheckBox exCheckBox;
	}
}