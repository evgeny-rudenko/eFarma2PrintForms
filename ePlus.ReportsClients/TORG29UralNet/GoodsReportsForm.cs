...
namespace RCRTORG29UralNet
{
  public partial class GoodsReportsForm : Form, IReportParams, IExternalReport
  {
    ...
    {
        Stream s = this.GetType().Assembly.GetManifestResourceStream("RCRTORG29UralNet.REPEX_TORG29_URALNET.sql");
    ...
    Stream s = this.GetType().Assembly.GetManifestResourceStream("RCRTORG29UralNet.TORG_29_URALNET.rdlc");
