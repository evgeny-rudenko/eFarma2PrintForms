...
GROUP BY T.ID_GOODS, T.ID_STORE
...
FETCH NEXT FROM DEF_CURSOR INTO @ID_GOODS, @ID_STORE, @G_CODE, @GOODS_NAME, @QUANTITY, @MIN
...
INSERT INTO @RESULT VALUES(@G_CODE, @GOODS_NAME, @QUANTITY, @MIN, @INCOME_DATE, @SUP, @PRICE_SUP, @PRICE_SAL, @ID_STORE)
...
select r.*, STORE_NAME = st.name, CONTRACTOR_NAME = ct.name from @result r
...
<XML>
	<DATE_FROM>2010-05-31T00:00:00.000</DATE_FROM>
	<DATE_TO>2010-05-31T18:33:57.968</DATE_TO>
