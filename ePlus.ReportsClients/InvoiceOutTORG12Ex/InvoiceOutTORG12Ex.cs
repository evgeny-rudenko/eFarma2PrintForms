...
namespace InvoiceOutTORG12Ex
{
	public class InvoiceOutTORG12Ex : AbstractDocumentReport, IExternalDocumentPrintForm
	{
		...
		{
			Stream s = this.GetType().Assembly.GetManifestResourceStream("InvoiceOutTORG12Ex.TORG12.sql");
		...
		{
			get { return "Расходные документы: ТОРГ-12 (альбом.)"; }
		}
	}
}
