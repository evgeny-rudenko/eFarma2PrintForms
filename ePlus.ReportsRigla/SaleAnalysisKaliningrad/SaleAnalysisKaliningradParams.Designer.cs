namespace SaleAnalysisKaliningrad
{
	partial class RemainderFrom1CParams
	{
		...
		private void InitializeComponent()
		{
			...
			this.chkRemainsOnly = new System.Windows.Forms.CheckBox();
			...
			// chkRemainsOnly
			// 
			this.chkRemainsOnly.AutoSize = true;
			this.chkRemainsOnly.Location = new System.Drawing.Point(25, 65);
			this.chkRemainsOnly.Name = "chkRemainsOnly";
			this.chkRemainsOnly.Size = new System.Drawing.Size(173, 17);
			this.chkRemainsOnly.TabIndex = 7;
			this.chkRemainsOnly.Text = "Только товары с движением";
			this.chkRemainsOnly.UseVisualStyleBackColor = true;
			// 
			...
			this.Controls.Add(this.chkRemainsOnly);
			...
			this.Controls.SetChildIndex(this.chkRemainsOnly, 0);
		...
		private System.Windows.Forms.CheckBox chkRemainsOnly;
	}
}