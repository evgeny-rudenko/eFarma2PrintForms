...
namespace FRBInv19
{
	public class Inv19 : AbstractDocumentReport, IExternalDocumentPrintForm
	{
		...
		{
      Stream s = this.GetType().Assembly.GetManifestResourceStream("FRBInv19.Inv19.sql");
      ...
      Stream s = this.GetType().Assembly.GetManifestResourceStream("FRBInv19.Inv19.rdlc");
      ...
      Utils.AddNode(root, "IS_SAL", isSal);
		...
		{
			get { return "ИНВ-19 (Ригла): Сличительная ведомость результатов инвентаризации товарно-материальных ценностей"; }
		}
