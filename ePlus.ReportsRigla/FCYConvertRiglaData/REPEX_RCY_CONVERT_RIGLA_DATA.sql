...
AS
    ...
    CREATE CLUSTERED INDEX IX_T1 ON #T (CODE_STU)
...
AS
    ...
    CREATE CLUSTERED INDEX IX_CS1 ON #CS (SUPIDAP)
...
AS
    ...
    BEGIN TRAN    
        ...
        SELECT
            ...
            SUM(T.KOL * T.COST_PRICE * (1+(T.NDS / 100.0000))),
            SUM(T.KOL * T.COST_PRICE * (T.NDS / 100.0000)),
            NULL,
            'SAVE',
            GETDATE(),
            GETDATE(),
        ...
        SELECT
            ...
            SUPPLIER_SUM_VAT = T.COST_PRICE * (1 + (T.NDS / 100.0000)) * T.KOL,
...
AS
    ...
    IF OBJECT_ID('tempdb..#DCT') IS NOT NULL DROP TABLE #DCT
    CREATE TABLE #DCT
    (
        TIPDKSTU INT,
    ...
    CREATE CLUSTERED INDEX IX_DC1 ON #DC (SHCOD)
    ...
    CREATE CLUSTERED INDEX IX_DCT1 ON #DCT (TIPDKSTU)    
