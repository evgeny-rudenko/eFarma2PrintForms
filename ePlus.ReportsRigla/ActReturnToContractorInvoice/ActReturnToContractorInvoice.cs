...
namespace ActReturnToContractorInvoice
{
	public class ActReturnToContractorInvoice : AbstractDocumentReport, IExternalDocumentPrintForm
	{
		...
		{
			Stream s = this.GetType().Assembly.GetManifestResourceStream("ActReturnToContractorInvoice.ActReturnToContractorInvoice.sql");
		...
		void ExtractReport()
		{
			...
			Stream s = this.GetType().Assembly.GetManifestResourceStream("ActReturnToContractorInvoice.ActReturnToContractorInvoice.rdlc");
