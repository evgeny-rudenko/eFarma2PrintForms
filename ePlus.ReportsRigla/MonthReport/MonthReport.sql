...
IF OBJECT_ID('DBO.REPEX_MONTH_REPORT_RIGLA') IS NULL EXEC ('CREATE PROCEDURE DBO.REPEX_MONTH_REPORT_RIGLA AS RETURN')
GO

ALTER PROCEDURE DBO.REPEX_MONTH_REPORT_RIGLA
    @XMLPARAM NTEXT AS
...
/*
EXEC DBO.REPEX_MONTH_REPORT_RIGLA N'
<XML>
